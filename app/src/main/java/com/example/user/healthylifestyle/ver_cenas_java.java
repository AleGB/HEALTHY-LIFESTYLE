...
public class ver_cenas_java extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ver_cenas_xml);
    ...
    public void verCena4(View view) {
        Intent screen = new Intent(this, ver_cena_4_java.class);
        startActivity(screen);
    }

    public void verCena3(View view) {
        Intent screen = new Intent(this, ver_cena_3_java.class);
        startActivity(screen);
    }

    public void verCena1(View view) {
        Intent screen = new Intent(this, ver_cena_1_java.class);
        startActivity(screen);
    }

    public void verCena2(View view) {
        Intent screen = new Intent(this, ver_cena_2_java.class);
        startActivity(screen);
    }
}
