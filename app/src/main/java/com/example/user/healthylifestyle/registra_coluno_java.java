...
public class registra_coluno_java extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    TextView colasionUno, indica;
    ViewGroup layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.registra_coluno_xml);
        Typeface face = Typeface.createFromAsset(getAssets(),"fonts/GrandHotel-Regular.ttf");

        colasionUno = findViewById(R.id.colasionUno);
        indica = findViewById(R.id.indica);
        colasionUno.setTypeface(face);
